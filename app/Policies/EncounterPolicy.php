...
class EncounterPolicy
{
	 ...
	 *
	 * @param  \App\Models\User  $user The currently authenticated user.
	 * @param  \App\Models\Encounter  $encounter The encounter being viewed.
	 ...
	 *
	 * @param  \App\Models\User  $user The currently authenticated user.
	 * @param  \App\Models\Encounter  $encounter The encounter to be updated.
	 ...
	 *
	 * @param  \App\Models\User  $user The currently authenticated user.
	 * @param  \App\Models\Encounter  $encounter The encounter to be deleted.
	 ...
	 *
	 * @param  \App\Models\User  $user The currently authenticated user.
	 * @param  \App\Models\Encounter  $encounter The encounter to which a character might be added.
	 ...
	 *
	 * @param  \App\Models\User  $user The currently authenticated user.
	 * @param  \App\Models\Encounter  $encounter The encounter.
