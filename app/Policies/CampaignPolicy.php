...
class CampaignPolicy
{
     ...
     *
     * @param User $user The currently authenticated user.
     * @param Campaign $campaign The campaign being viewed.
     ...
     *
     * @param User $user The currently authenticated user.
     * @param Campaign $campaign The campaign to be deleted.
     ...
     *
     * @param User $user The currently authenticated user.
     * @param Campaign $campaign The campaign to which a character might be added.
     ...
     *
     * @param User $user The currently authenticated user.
     * @param Campaign $campaign The campaign to which characters might be attached.
     ...
     *
     * @param User $user The currently authenticated user.
     * @param Campaign $campaign The campaign from which characters might be detached.
